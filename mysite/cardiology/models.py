...
class ECGResult(models.Model):
    ...
    qt_interval_global = models.IntegerField(blank=True, null=True)
    qtc_interval_global = models.IntegerField(blank=True, null=True)
    pr_interval_global = models.IntegerField(blank=True, null=True)
    qrs_duration_global = models.IntegerField(blank=True, null=True)
    rr_interval_global = models.IntegerField(blank=True, null=True)
    ...
    p_amplitude = models.IntegerField(blank=True, null=True)
    p_duration = models.IntegerField(blank=True, null=True)
    q_amplitude = models.IntegerField(blank=True, null=True)
    q_duration = models.IntegerField(blank=True, null=True)
    r_amplitude = models.IntegerField(blank=True, null=True)
    r_duration = models.IntegerField(blank=True, null=True)
    s_amplitude = models.IntegerField(blank=True, null=True)
    s_duration = models.IntegerField(blank=True, null=True)
